        ...
        it('should handle parsing exceptions', done => {
          ...
          agent
            .use(traces => {
              ...
              expect(spans[0].meta).to.have.property('sfx.error.kind', error.name)
              expect(spans[0].meta).to.have.property('sfx.error.object', error.name)
              expect(spans[0].meta).to.have.property('sfx.error.message', error.message)
              expect(spans[0].meta).to.have.property('sfx.error.stack', error.stack)
            })
            .then(done)
            .catch(done)
        ...
        it('should handle validation errors', done => {
          ...
          agent
            .use(traces => {
              ...
              expect(spans[0].meta).to.have.property('error', 'true')
              expect(spans[0].meta).to.have.property('sfx.error.kind', errors[0].name)
              expect(spans[0].meta).to.have.property('sfx.error.object', errors[0].name)
              expect(spans[0].meta).to.have.property('sfx.error.message', errors[0].message)
              expect(spans[0].meta).to.have.property('sfx.error.stack', errors[0].stack)
            })
            .then(done)
            .catch(done)
